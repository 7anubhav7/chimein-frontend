...
describe('Register', () => {
  ...
  describe('Button', () => {
    ...
    it('should be enabled with input values', () => {
      ...
      userEvent.type(usernameLabel, 'danny');
      userEvent.type(emailLabel, 'danny@test.com');
  ...
  describe('Success', () => {
    it('should navigate to streams page', async () => {
      ...
      userEvent.type(usernameElement, 'danny');
      userEvent.type(emailElement, 'danny@test.com');
